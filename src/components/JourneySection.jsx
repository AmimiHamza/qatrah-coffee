...
const journeySteps = [
  {
    ...
    descAr:
      'في أعالي جبال جازان على ارتفاع 1800 متر، ينمو بن عربي أصيل بعيداً عن أي ضغوط. مزارعون سعوديون يتوارثون المهنة جيلاً بعد جيل، يقطفون حبات القهوة الحمراء يدوياً في موسم الحصاد.',
    stat: { num: '1800م', label: 'ارتفاع المزارع' },
  ...
  },
  {
    ...
    stat: { num: '+200°', label: 'درجة التحميص' },
  ...
  },
  {
    ...
    stat: { num: '93°', label: 'حرارة الإعداد المثلى' },
      ...
      <div ref={textRef} className={`bg-espresso-800 p-8 lg:p-10 flex flex-col justify-center ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
        ...
        <div className="reveal-text flex items-center gap-4 pt-5 border-t border-white/8">
          ...
          <div className="font-tajawal text-cream-200/35 text-xs">
            مرحلة {step.step} من 04 مراحل رحلة البن
          </div>
        </div>
      </div>
    </div>
