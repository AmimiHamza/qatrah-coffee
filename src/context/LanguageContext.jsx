...
export const translations = {
  ar: {
    ...
    footer: {
      ...
      terms: 'شروط الخدمة',
      tagline: 'نبني مواقع مقاهي استثنائية لعملاء حول العالم — جميلة، سريعة، وتحوّل الزوار إلى عملاء.',
  ...
  en: {
    ...
    footer: {
      ...
      tagline: 'We build exceptional café websites for clients worldwide — beautiful, fast, and built to convert.',
  ...
  fr: {
    ...
    footer: {
      ...
      tagline: 'Nous créons des sites cafés exceptionnels pour des clients partout dans le monde — beaux, rapides et conçus pour convertir.',
