...
export const translations = {
  ar: {
    ...
    hero: {
      ...
      sub: '0 ريال رسوم تأسيس. نبني موقع مقهاك الاستثنائي — لوحة تحكم ذكية، طلب أونلاين، حجوزات — مقابل اشتراك شهري بسيط.',
      cta1: 'ابدأ بـ 0 ريال اليوم',
      cta2: 'شاهد لوحة التحكم',
      badges: ['100٪ مخصص', 'ثنائي اللغة EN/AR', 'متوافق مع الجوال', 'تسليم خلال أسبوع'],
      stats: [
        { num: '+40', label: 'مقهى تخدمه' },
        { num: '3', label: 'قارات' },
        { num: '98٪', label: 'رضا العملاء' },
      ],
      discover: 'اكتشف',
      floatLabel: 'موقع مقهاك جاهز',
      floatSub: 'خلال 7 أيام فقط ☕',
    },
    features: {
      tag: 'صمم حزمتك',
      title: 'اختر ما يناسب',
    ...
    process: {
      ...
      sub: 'عملية مجربة وواضحة — 4 مراحل لتحويل رؤيتك إلى موقع مقهى استثنائي يحوّل الزوار إلى عملاء.',
      ...
      steps: [
        {
          ...
          stat: { num: '30 د', label: 'جلسة اكتشاف مجانية' },
        ...
        },
        {
          ...
          stat: { num: '3', label: 'نماذج للاختيار' },
        ...
        },
        {
          ...
          stat: { num: '100', label: 'نقاط PageSpeed' },
        ...
        },
        {
          ...
          stat: { num: '7 أيام', label: 'من الاتفاق للإطلاق' },
    ...
    dashboard: {
      ...
      interestedSub: 'احصل على عرض توضيحي مجاني لمدة 30 دقيقة — بدون أي التزام',
    ...
    contact: {
      ...
      sub: 'سواء كنت تريد موقعاً بسيطاً أو منصة متكاملة — تواصل معنا وسنرد خلال 24 ساعة.',
      namePh: 'اسمك الكريم',
